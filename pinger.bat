...
echo =====================================================
echo WELCOME TO SHIFTS GRIM REAPER PINGER. 
echo =====================================================
echo                ...
echo              ;::::;
echo           ;::::; :;
...
echo    ::::::`:::::;'  /  /   `#
echo.
echo please type "lmk" to search your targets ip info!
echo.
echo.
:hub
set /p var=Enter IP~
if %var%==lmk goto iplook
